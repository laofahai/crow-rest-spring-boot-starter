...
//        Class<?> type = pd.getPropertyType();
        ...
        AllowFuzzySearch allowFuzzySearch = field.getAnnotation(AllowFuzzySearch.class);
        ...
        if(tableField != null) {
            fs.setPhysicalFieldName(tableField.value());
        } else {
            fs.setPhysicalFieldName(NamingUtils.camelToLine(field.getName()));
        }

        if(allowFuzzySearch != null) {
            fs.setAllowFuzzySearch(true);
        }
